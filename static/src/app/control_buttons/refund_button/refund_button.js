...
patch(RefundButton.prototype,  {
 ...
 async loadUserRights() {
    ...
    if (currentUser.role === 'manager') {
     ...
     // Access the disable_remove_order_line_basic_right configuration
     // const disableRemoveOrderLine = this.env.pos.config.rights;
     // console.log(disableRemoveOrderLine)
    ...
    this.userRights.rights = rightsDescription;
      ...
      async click() {
        if (this.state.disabled) {
            console.log("User does not have rights to use the refund button.");
